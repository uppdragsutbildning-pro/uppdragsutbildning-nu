...
export function OmTjansten() {
  const cards = [
    {
      icon: <Building className="w-6 h-6 text-[var(--marketplace-primary)]" />,
    ...
    {
      icon: <Settings className="w-6 h-6 text-[var(--marketplace-primary)]" />,
      title: 'Flexibelt upplägg',
      text: 'Utbildningen kan anpassas helt efter er verksamhets schema, mål och specifika utmaningar.',
    },
    {
      icon: <GraduationCap className="w-6 h-6 text-[var(--marketplace-primary)]" />,
    ...
    {
      icon: <UserCheck className="w-6 h-6 text-[var(--marketplace-primary)]" />,
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-white border-b border-slate-200 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block bg-[var(--marketplace-primary)]/10 text-[var(--marketplace-primary)] text-xs font-semibold px-3 py-1 rounded-full mb-4 tracking-wide uppercase">
            Om tjänsten
          </span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {cards.map((item, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-slate-200 hover:border-blue-200 hover:shadow-sm transition-all">
                <div className="w-11 h-11 bg-[var(--marketplace-primary)]/15 rounded-xl flex items-center justify-center mb-4">
                  {item.icon}
                </div>
      ...
      <section className="pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[var(--marketplace-primary)] to-[var(--marketplace-primary)]/90 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <Link
              to="/request"
              className="shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-white text-[var(--marketplace-primary)] rounded-lg font-semibold hover:bg-[var(--marketplace-primary)]/10 transition-colors"
            >
              Kom igång
